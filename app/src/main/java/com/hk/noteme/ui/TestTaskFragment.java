...
public class TestTaskFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = inflate(inflater, R.layout.fragment_test_task, container, false);
        context = container.getContext();
        //init
        taskViewModel = new ViewModelProvider(this).get(TaskViewModel.class);
        taskList = new ArrayList<>();
        taskAdapter = new TaskListAdapter(context);
        binding.testTaskRV.setLayoutManager(new LinearLayoutManager(context));
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        binding.addTaskFB.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("status_position", 2);
    ...
    public void populateData() {
        taskViewModel.getAllTask().observe(getActivity(), new Observer<List<Task>>() {
            ...
            public void onChanged(List<Task> tasks) {
                taskList.clear();
                for (Task task : tasks) {
                    if (task.getTaskStatus().equals("Test")) {
                        taskList.add(task);
                    }
                }
                ...
                binding.testTaskRV.setAdapter(taskAdapter);
            }
        });
    }
